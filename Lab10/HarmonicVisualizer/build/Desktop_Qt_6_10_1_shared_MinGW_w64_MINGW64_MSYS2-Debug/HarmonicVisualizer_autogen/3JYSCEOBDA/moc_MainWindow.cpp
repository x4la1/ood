...
template <> constexpr inline auto MainWindow::qt_create_metaobjectdata<qt_meta_tag_ZN10MainWindowE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'UpdateHarmonicsList'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'UpdateEditFields'
        QtMocHelpers::SlotData<void(double, double, double, FunctionType)>(3, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Double, 4 }, { QMetaType::Double, 5 }, { QMetaType::Double, 6 }, { 0x80000000 | 7, 8 },
        }}),
        // Slot 'UpdateChart'
